...
class RMSCommerceSynchronizationController extends Controller
{
    ...
    private function processStoreFiles()
    {
        ...
        foreach ($stores as $store) {
            ...
            foreach ($itemList as $item) {
                ...
                $filename = "{$storeName}-{$itemDepartment}.csv";
                ...
                try {
                    ...
                    $this->uploadFileViaSSH('colon-supermarket.csv', '/home/1432876.cloudwaysapps.com/vbwfxktvwd/public_html/cron_job/inventory_sync/marengems/csv/colon-supermarket');
    ...
    private function calculateAllocatedStock($stock, $department)
    {
        ...
        } elseif (strtolower($department) === 'departmentstore') {
