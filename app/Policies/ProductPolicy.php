...
class ProductPolicy
{
    ...
    {
        return $user->hasRole('superadmin') || $user->hasRole('admin') || $user->hasRole('store manager') || $user->hasPermission('bulk_edit_products');
    }
    ...
    {
        return $user->hasRole('superadmin') || $user->hasRole('admin') || $user->hasRole('store manager') || $user->hasPermission('bulk_archive_products');
    }
