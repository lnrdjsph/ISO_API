														...
														<div class="relative w-full">
																...
																>
																		...
																		@foreach (['E-Commerce', 'Store', 'ISO Retail', 'Wholesale'] as $option)
																				<option
																						value="{{ $option }}"
																						{{ old('channel_order') == $option ? 'selected' : '' }}
																				>{{ $option }}</option>
																		@endforeach
																</select>
																<label
																...
																if (cardNo.length === 16) {
																		try {
																				...
																				if (response.ok && data.status === "200") {
																						...
																						// Add bg-indigo-50 when fields are filled
												...
												<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
														<div class="relative">
																<input
																		...
																		class="required-input peer block w-full appearance-none rounded-md border border-gray-300 px-3 pb-2 pt-6 text-sm text-gray-900 placeholder-transparent focus:border-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-900"
																		autocomplete="off"
																		value="{{ old('payment_center', $mappedLocation) }}"
																>
																...
																>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">F2 - Metro Wholesalemart Colon</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">S10 - Metro Maasin</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">S17 - Metro Tacloban</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">S19 - Metro Metro Bay-Bay</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">F18 - Metro Alang-Alang</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">F19 - Metro Hilongos</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">S8 - Metro Toledo</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">H8 - Super Metro Antipolo</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">H9 - Super Metro Carcar</li>
																		<li class="cursor-pointer p-2 hover:bg-gray-100">H10 - Super Metro Bogo</li>
																</ul>
														</div>
														...
														<div class="relative">
																...
																>
																		<option
																				value=""
																				disabled
																				{{ old('mode_payment') ? '' : 'selected' }}
																		>Select or type payment mode</option>
																		<option
																				value="PO15%"
																				{{ old('mode_payment') == 'PO15%' ? 'selected' : '' }}
																		>PO15%</option>
																		<option
																				value="Cash / Bank Card"
																				{{ old('mode_payment') == 'Cash' ? 'selected' : '' }}
