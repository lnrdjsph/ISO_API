    ...
    <div class="mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            <form
                ...
                <select
                    name="store"
                    class="rounded-md border border-gray-300 px-2 py-1.5 pe-8 text-xs shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td
                                        colspan="4"
                                        class="px-3 py-2 text-center text-gray-500">No products found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td
                                        colspan="4"
                                        class="px-3 py-2 text-center text-gray-500">No freebies found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
