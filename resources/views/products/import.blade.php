...
@section('content')
                        ...
                        <div class="rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 p-3 shadow-lg">
                            <svg
                                ...
                                <path
                                    ...
                                    d="M7 16a4 4 0 0 1-.88-7.9A5 5 0 1 1 15.9 6L16 6a5 5 0 0 1 1 9.9M15 11l-3-3m0 0l-3 3m3-3v12"></path>
                            </svg>
                        </div>
                        <div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p
                                    id="progressText"
                                    class="text-sm text-gray-600">0% complete</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <h4
                                    ...
                                    id="fileName">File loaded successfully!</h4>
                                <p
                                    class="text-sm text-gray-600"
                                    id="fileDetails">Ready to process</p>
                            </div>
                            <button
                                type="button"
                                id="removeFile"
                                ...
                                <div class="grid gap-4 md:grid-cols-[2fr_3fr]">
                                    ...
                                    <div>
                                        ...
                                        <ol class="list-[upper-alpha] space-y-1 pl-5 text-xs text-gray-700">
                                            ...
                                            <li><strong>Freebie SKU</strong> → Optional. Digits only, multiple allowed via <code>|</code> or <code>/</code> (e.g. <code>9413022 | 8404794</code>).
                                            </li>
                                        </ol>
            ...
            <div
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2 rounded bg-green-100 px-3 py-1">
                        ...
                        <span
                            id="recordCount"
                            class="text-sm font-medium text-green-700">0 records found</span>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full overflow-hidden rounded-lg border border-gray-200 bg-white">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="border-b px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">1</th>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function processFile(file) {
                ...
                reader.onload = function(e) {
                    ...
                    const expectedColumns = 9; // ✅ Now 9 because of discount_scheme
                    const validRows = [];
                    ...
                    lines.slice(1).forEach((line, index) => {
                        ...
                        const [
                            ...
                            cbc_scheme,
                            po15_scheme,
                            discount_scheme, // ✅ comes before freebie_sku
                            freebie_sku_raw
                        ] = cols;
                        ...
                        if (case_pack !== '' && !/^\d+( \| \d+)*$/.test(case_pack)) isValid = false;
                        ...
                        // Discount scheme validation - can be empty
                        if (discount_scheme && discount_scheme.trim() !== '') {
                            if (!/^\d+%?$/.test(discount_scheme.trim())) {
                                isValid = false;
                            }
                        }
            ...
            function renderPreviewChunk() {
                ...
                nextChunk.forEach((row, idx) => {
                    const action = row.action;
                    const tr = document.createElement('tr');
                    tr.classList.add('hover:bg-gray-50');

                    const rowNumber = previewOffset + idx + 2; // keep numbering across chunks
    ...
    <td class="px-4 py-3 text-sm text-gray-700">${escapeHtml(row.discount_scheme)}</td>
...
`;
                    ...
                    document
                        ...
                        .addEventListener('click', renderPreviewChunk);
                }
            }
