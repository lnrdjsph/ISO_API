...
`;
                ...
                `;
						...
						document.getElementById('downloadTemplate').addEventListener('click', (e) => {
								e.preventDefault();
								const csvContent =
										'SKU,Product Description,Store Allocation,SRP,Cash Bank Card Scheme,PO15 Scheme,Freebie SKU\n102806178,Bearbrand Pwdr Mlk 128-192/33G,500,11.20,15+1,15+2,9413022\n8404794,Lucky Me Pc Xtra Hot Chi72/60G,600,11.50,10+1,8+1,8404794';
