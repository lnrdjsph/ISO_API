                        ...
                        <div class="flex-1">
                            <div class="grid md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-md text-gray-600 mb-2">Your CSV file should have exactly 2 columns:</p>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full text-xs text-gray-700 font-mono border border-gray-300">
                                            <thead class="bg-gray-100">
                                                <tr>
                                                    <th class="px-3 py-2 border border-gray-300 text-left">SKU</th>
                                                    <th class="px-3 py-2 border border-gray-300 text-left">Product Description</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="hover:bg-gray-50">
                                                    <td class="px-3 py-2 border border-gray-300">102806178</td>
                                                    <td class="px-3 py-2 border border-gray-300">Bearbrand Pwdr Mlk 128-192/33G</td>
                                                </tr>
                                                <tr class="hover:bg-gray-50">
                                                    <td class="px-3 py-2 border border-gray-300">8404794</td>
                                                    <td class="px-3 py-2 border border-gray-300">Lucky Me Pc Xtra Hot Chi72/60G</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b">SKU</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b">Product Description</th>
                        </tr>
                    </thead>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        previewBtn.addEventListener('click', () => {
            ...
            csvData.slice(0, 10).forEach(row => {
                ...
                tr.innerHTML = `
                    <td class="px-6 py-4 text-sm text-gray-900 font-medium">${escapeHtml(row.sku)}</td>
                    <td class="px-6 py-4 text-sm text-gray-700">${escapeHtml(row.description)}</td>
                `;
        ...
        document.getElementById('downloadTemplate').addEventListener('click', (e) => {
            e.preventDefault();
            const csvContent = 'SKU,Product Description\n102806178,Bearbrand Pwdr Mlk 128-192/33G\n8404794,Lucky Me Pc Xtra Hot Chi72/60G';
