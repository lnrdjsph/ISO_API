...
@section('content')
    <div class="">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-600">Enroll multiple products efficiently with our batch creation tool</p>
                        </div>
                    </div>
                ...
                <form
                    ...
                    <div
                        ...
                        <div class="product-row group">
                            <div class="rounded-xl border border-blue-100 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 p-6 transition-all duration-300 hover:shadow-md">
                                <div class="mb-4 flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 text-sm font-semibold text-white">
                                            1
                                        </div>
                                    ...
                                    <button
                                        type="button"
                                        class="btn-remove-row rounded-lg p-2 text-red-500 opacity-0 transition-opacity duration-200 hover:bg-red-50 hover:text-red-700 group-hover:opacity-100">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5"
                                            fill="none"
                                ...
                                <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div class="space-y-2">
                                        <label
                                            for="sku_0"
                                            class="block flex items-center space-x-2 text-sm font-medium text-gray-700">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <input
                                            ...
                                            class="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:shadow-md focus:border-transparent focus:ring-2 focus:ring-blue-500"
                                            required>
                                    </div>
                                    ...
                                    <div class="space-y-2 md:col-span-2">
                                        <label
                                            ...
                                            <span>Product Description</span><span class="text-red-500">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            name="description[]"
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7">
                                    <div>
                                        <label
                                            for="case_pack_0"
                                            class="block text-sm font-medium text-gray-700">Case Pack</label>
                                        <input
                                            type="number"
                                            name="case_pack[]"
                                            id="case_pack_0"
                                    ...
                                    <div>
                                        <label
                                            for="srp_0"
                                            class="block text-sm font-medium text-gray-700">SRP</label>
                                        <input
                                            type="number"
                                            step="0.01"
                                            name="srp[]"
                                    ...
                                    <div>
                                        <label
                                            for="allocation_per_case_0"
                                            class="block text-sm font-medium text-gray-700">Allocation / Case</label>
                                        <input
                                            type="number"
                                            name="allocation_per_case[]"
                                            id="allocation_per_case_0"
                                            placeholder="e.g. 100"
                                            class="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
                                    </div>
                                    ...
                                    <div>
                                        <label
                                            for="cbc_scheme_0"
                                            class="block text-sm font-medium text-gray-700">C/BC Scheme</label>
                                        <input
                                            type="text"
                                            name="cbc_scheme[]"
                                            id="cbc_scheme_0"
                                    ...
                                    <div>
                                        <label
                                            for="po15_scheme_0"
                                            class="block text-sm font-medium text-gray-700">PO15 Scheme</label>
                                        <input
                                            type="text"
                                            name="po15_scheme[]"
                                            id="po15_scheme_0"
                                    ...
                                    <div>
                                        <label
                                            ...
                                            class="block text-sm font-medium text-gray-700">Discount Scheme</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label
                                            for="freebie_sku_0"
                                            class="block text-sm font-medium text-gray-700">Freebie SKU</label>
                                        <input
                                            type="text"
                                            name="freebie_sku[]"
                                            id="freebie_sku_0"
                    ...
                    <div class="mt-8">
                        <button
                            type="button"
                            id="add-row-btn"
                            class="group inline-flex w-full items-center justify-center rounded-xl border-2 border-dashed border-gray-300 px-6 py-3 text-gray-600 transition-all duration-200 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-6">
                        <div class="flex flex-col justify-between gap-4 sm:flex-row">
                            <a
                                ...
                                class="group inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-gray-700 shadow-sm transition-all duration-200 hover:bg-gray-50 hover:shadow-md">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="flex space-x-4">
                                <button
                                    type="button"
                                    id="clear-all-btn"
                                    class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-gray-700 shadow-sm transition-all duration-200 hover:bg-gray-50 hover:shadow-md">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="mr-2 h-5 w-5"
                                        fill="none"
                                ...
                                <button
                                    type="submit"
                                    class="group inline-flex transform items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3 text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="mr-2 h-5 w-5 transition-transform duration-200 group-hover:scale-110"
                                        fill="none"
            ...
            <!-- Help Section -->
            <div class="mt-8 rounded-xl border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 p-6">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="mb-2 text-lg font-medium text-gray-900">Quick Tips</h3>
                        <ul class="space-y-1 text-sm text-gray-600">
                            ...
                            <li class="flex items-center space-x-2">
                                ...
                                <span>You can input multiple Freebie SKU by separating them with '/'. e.g. 15003036/6447779.</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
...
<style nonce="{{ $cspNonce }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                ...
                                <div class="md:col-span-2 space-y-2">
                                    <label for="description_0" class="block text-sm font-medium text-gray-700 flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                        </svg>
                                        <span>Product Description</span><span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" name="description[]" id="description_0" placeholder="Enter product description"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white shadow-sm hover:shadow-md"
                                        required>
                                </div>
                            </div>
