				...
				<tr>
						<td align="center">
								...
								>
										...
										<!-- Header -->
										<tr>
												<td style="background:#296D38; padding:20px; color:#fff; font-size:20px; font-weight:bold; text-align:center;">
														Order Approved
												</td>
										</tr>
										...
										<tr>
												<td style="padding:20px; font-size:14px; color:#333;">
														Hello <strong>{{ \App\Models\User::find($order->requested_by)?->name }}</strong>,
														<br><br>
										...
										<tr>
												...
												>
														<a
																...
																style="background:#296D38; color:#fff; text-decoration:none; padding:12px 24px; border-radius:6px; font-weight:bold; display:inline-block;"
														>
																View Approved Order
														</a>
												</td>
