		...
		>
				...
				<div class="me-0 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 md:me-64">
						<div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
								...
								<aside
										class="md:shadow-0 relative right-0 top-0 mt-16 flex w-full flex-col rounded-lg bg-gray-100 p-6 py-16 shadow-none md:fixed md:mt-0 md:h-screen md:w-64 md:bg-none"
										style="z-index: 1000;"
								>
										<div
												id="orderTotalDisplay"
												class="mb-6 rounded-lg border border-gray-300 bg-white px-12 py-4 shadow-md md:mx-auto md:mt-16 md:max-w-sm"
										>
												...
												<div class="mb-4 flex items-center justify-between border-t border-gray-200 pt-4">
